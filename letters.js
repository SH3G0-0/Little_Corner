...
/* 
   ...
   instead of the default ones, just scroll down to the "themeMap" variable (around line 200) 
...
try {
    ...
    letterStyles.innerHTML = `
        ...
        /* Inner Wrapper - INCREASED TOP PADDING SO IT IS NOT CUT OFF AT THE TOP */
    ...
    const topNotes = ["Just thinking about you...", "You look really beautiful today.", "I love you.", "I'm so lucky to know you.", "You mean the world to me.", "I hope this makes you smile.", "You are so deeply loved."];
    const doodles = ["🌸", "☁️", "♡", "⭐", "🐇"];

    // --- Dynamic Theme Graphics Engine (Replaces repeating background) ---
    ...
    window.openEnvelope = function(id, element) {
        ...
        setTimeout(() => {
            ...
            // Sweet Note Top (Replaces Timestamp)
            document.getElementById('paper-top-note').innerText = topNotes[Math.floor(Math.random()*topNotes.length)];
